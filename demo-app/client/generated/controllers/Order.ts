...
export class OrderService {
  ...
  orderWithResponse(params: OrderParams):Observable<HttpResponse<object>> {
    ...
    return this.http.post<object>(`/api-base-path/order`, bodyParams || {}, {params: queryParams, observe: 'response'});
  }
  ...
  patchOrderWithResponse(params: PatchOrderParams):Observable<HttpResponse<object>> {
    ...
    return this.http.patch<object>(`/api-base-path/order/${pathParams.orderId}`, bodyParams || {}, {observe: 'response'});
  }
  ...
  putOrderWithResponse(params: PutOrderParams):Observable<HttpResponse<object>> {
    ...
    return this.http.put<object>(`/api-base-path/order/${pathParams.orderId}`, bodyParams || {}, {observe: 'response'});
  }
